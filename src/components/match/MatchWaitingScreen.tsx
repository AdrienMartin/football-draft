...
export function MatchWaitingScreen({
  ...
  description = 'Ta validation a bien été prise en compte. Le match démarrera dès que l autre joueur aura aussi lancé la simulation.',
  ...
  return (
    <section className="rounded-3xl border border-white/10 bg-white/5 p-6 shadow-2xl shadow-black/20 backdrop-blur sm:p-10">
      <div className="flex min-h-[260px] flex-col items-center justify-center text-center sm:min-h-[360px]">
